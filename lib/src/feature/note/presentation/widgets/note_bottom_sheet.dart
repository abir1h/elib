...
import '../../../book/presentation/services/book_view_screen_service.dart';
      ...
      child: Scaffold(
        ...
        body: Align(
          ...
          child: Container(
              ...
              padding:
                  EdgeInsets.only(top: size.h10, right: size.w16, left: 20),
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          controller
                              .getText()
                              .then((value) => onCreateNotes(NoteDataEntity(
                                    bookId: widget.noteDataEntity!.bookId,
                                    emisUserId:
                                        widget.noteDataEntity!.emisUserId,
                                    note: value,
                                  )));
