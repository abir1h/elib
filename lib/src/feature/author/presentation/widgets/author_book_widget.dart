...
class _AuthorBookWidgetState extends State<AuthorBookWidget>
    with AppTheme {
  @override
  void initState() {
    super.initState();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                    ...
                    GestureDetector(
                      child: Container(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQqijj5f7q3C0vBN3ruYwiXP_suunlaG_rYyBrMsgH_ZNy44_b9",
          ...
          Expanded(
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: size.h8,vertical: size.h8  ),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                    "The Picture Of Dorian Gray.",style: TextStyle(fontWeight: FontWeight.w500,fontSize: size.textXXSmall,fontFamily: StringData.fontFamilyRoboto),
